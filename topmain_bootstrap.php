...
/**
 * Bootstrap-based drop-in replacement for topmain.php. Same links/session
 * logic as topmain.php -- only the HTML output differs. Used by pages
 * migrated to the new Bootstrap layout (see issue #40); topmain.php itself
 * is untouched and still serves every page not yet migrated.
 */
