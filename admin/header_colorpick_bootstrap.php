...
/**
 * Bootstrap-based drop-in replacement for admin/header_colorpick.php. Same
 * connectivity/IP/timezone checks as admin/header_bootstrap.php, plus the
 * ColorPicker2.js script and `cp` instance that pages with a color-picker
 * field depend on. Used by admin pages migrated to the new Bootstrap layout
 * (see issue #40); admin/header_colorpick.php itself is untouched and still
 * serves every admin page not yet migrated.
 */
