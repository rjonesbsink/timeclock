...
/**
 * Bootstrap-based drop-in replacement for admin/header_date.php. Same
 * connectivity/IP/timezone checks as admin/header_bootstrap.php, plus the
 * CalendarPopup.js script and `cal` instance that pages with a date-picker
 * field depend on. Used by admin pages migrated to the new Bootstrap layout
 * (see issue #40); admin/header_date.php itself is untouched and still
