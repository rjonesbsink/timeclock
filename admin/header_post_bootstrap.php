...
/**
 * Bootstrap-based drop-in replacement for admin/header_post.php. Same
 * connectivity/IP/timezone checks as admin/header_bootstrap.php, plus the
 * office/group cascading-dropdown script (scripts/dropdown_post.php) and the
 ...
 * issue #40); admin/header_post.php itself is untouched and still serves
