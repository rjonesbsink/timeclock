...
/**
 * Bootstrap-based drop-in replacement for admin/header_get.php. Same
 * connectivity/IP/timezone checks as admin/header_bootstrap.php, plus the
 * office/group cascading-dropdown script (scripts/dropdown_get.php) and the
 * body onload='office_names();' hook that pages with that dropdown pair
 * depend on. Used by admin pages migrated to the new Bootstrap layout (see
 * issue #40); admin/header_get.php itself is untouched and still serves
...
include_once '../scripts/dropdown_get.php';
...
?>
<body class="bg-light" onload="office_names();">
