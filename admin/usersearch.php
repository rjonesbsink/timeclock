...
if ((!preg_match('/' . USERNAME_PATTERN . '/i', $post_username)) || (!preg_match('/' . USERNAME_PATTERN . '/i', $display_name)) ||
...
echo "        <tr class=right_main_text>\n";
echo "          <td valign=top>\n";
if (!preg_match('/' . USERNAME_PATTERN . '/i', $post_username)) {
    if ($post_username == "") {
    } else {
        echo "            <br />\n";
